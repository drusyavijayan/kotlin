...
enum class LanguageFeature(
    ...
    GenerateNullChecksForGenericTypeReturningFunctions(KOTLIN_1_4),
    ...
    GenerateNullChecksForGenericTypeReturningFunctions(sinceVersion = KOTLIN_1_3, defaultState = State.DISABLED),
    ;
